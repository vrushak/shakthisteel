...
function disp(){
	...
	document.getElementById("refresh").style.visiblity = "visible";
		...
		//	}
           ...
           // strSplit = option.split(',');
		     ...
		     //qty = Math.random();
			  ...
			  newCell.innerHTML="<tr><td class='goods'><input  form ='billsave'  required class= 'form-control input-sm goods'  id= 'goods' name='goods' list= 'products'  ><datalist id='products'><c:forEach var='p'  items='${model.list3}'><option data-value ='${p.discount},${p.quantity},${p.rate},${p.amount}' id='{p.discount}' value='${p.discount}'>${p.discount}</option></c:forEach></datalist></td></tr>";
			   newCell.style.width ='300px';
			  
			  newCell = rowsAdd.insertCell();
			  newCell.innerHTML="<tr><td class='quantity'><input form ='billsave' required onkeypress='return event.charCode >= 48 && event.charCode <= 57' class= 'form-control input-sm'  type='text'  id = '"+qtya+"' name= 'quantity' value='0' onblur = calc("+ratea+","+qtya+","+amta+") required  ></td></tr>";
			  newCell.style.width ='120px';
			  
			  newCell = rowsAdd.insertCell();
			  newCell.innerHTML="<tr><td><input form ='billsave' class= 'form-control input-sm' required type='text'  id = '"+ratea+"' name= 'rate' value='0' onblur = calc("+ratea+","+qtya+","+amta+")  required  ></td></tr>";
			  newCell.style.width ='120px';
			  
			  newCell = rowsAdd.insertCell();
			  newCell.innerHTML="<tr><td><input form ='billsave'  class= 'form-control input-sm' required readonly='readonly' type='text'  id = '"+amta+"' name= 'amount'  required  ></td></tr>";
...
<body class="body" onload="dispspan(),disable()">
  <div class="wrapper">
  ...
  <center>
	...
	<div id="page-wrap">
        <h1>
	     <button type="button" class="btn btn-warning button1" id='refresh' onclick='location.href="http://localhost:8085/shakthisteel/billgen2"'>
	  <span class="fa fa-refresh fa-spin"></span> Refresh</button>
<font size="5">Tax Invoice</font><span class="button2">
		<input type="button" id="disp" class="btn btn-warning button2" value="Print" disabled onclick="disp()" style="width:150px"/></span>
		
		 </h1>
		
		<br>
		<form id="billsave" action ="billsave2.html" method="post"></form>
   ...
   <div class="col-xs-6">
       ...
       <div class="col-xs-1" id="original"><font color="red"><strong>Original</strong></font></div>
   ...
   <p id="billed"> Billed To</p>
     ...
     <tr>
                ...
                <tr>
                    ...
                    <td style=""><input type="text" maxlength="14" value="+91-"  id="mobile" maxlength="14" name="mobile" form="billsave" onkeypress='return event.charCode >= 48 && event.charCode <= 57'></td>
    	...
    	<thead class="thead">
		  ...
		  <tr onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
	  ...
	  <span class="fa fa-refresh fa-spin"></span> Generate Total</button>
		...
		<table id="meta2">
		      ...
		      <td style="width:10px" class="total-value"><div id="subtotal"><input type="text" style="width:100px" readonly="readonly" class="form-control input-sm" value="0.00" id="subt" name="subtotal" form="billsave"></div></td>
                </tr>
                <tr>

                    
                     <td colspan="" class="total-line meta-head">CGST @ 14%</td>
		      <td class="total-value"><div id=""><input type="text" max="12" class="form-control input-sm" style="width:100px" readonly="readonly" onkeyup='calctax()' value="0.00" name="cgst" id="cgst" form="billsave"></div></td>
                </tr>
                <tr>
                    <td colspan="" class="total-line meta-head">SGST @ 14%</td>
		      <td class="total-value"><div id=""><input type="text" readonly="readonly" min =0 max="100" class="form-control input-sm" style="width:100px" onkeyup='calctax()' value="0.00" name="sgst" id="sgst" form="billsave"></div></td>
                </tr>
                <tr>
                    <td colspan="" class="total-line meta-head">Total GST</td>
		      <td class="total-value"><div id=""><input type="text" id="gst" name="gst" readonly="readonly" class="form-control input-sm" style="width:100px" onkeyup='calctax()' value="0.00" form="billsave"></div></td>
                </tr>
                <tr>
                    <td colspan="" class="total-line meta-head">Grand Total</td>

		      <td class="total-value balance"><input type="text"  readonly="readonly" id="gtotal"  value="0.00" style="width:100px" name="total" class="form-control input-sm due" form="billsave"></td>
                </tr>
	...
	<div class="form-group row" >
       ...
       Signature
        ...
        <center><font color="orange">FURNITURE AND INTERIORS UNDER ONE ROOF!!!</font></center>
